...
<html>
 ...
 <div class="navigation_bar" >
  <a href='http://121.42.174.147:8080/Movie/getRecommendedMoviesByOurAlgorithm.action'>猜你喜欢</a>
  <a href='http://121.42.174.147:8080/Movie/getHotMovies.action'>热门电影</a>
  <a href='http://121.42.174.147:8080/Movie/romance.action?type=byRating&genres=${genres}'>按评分</a>
  <a href='http://121.42.174.147:8080/Movie/romance.action?type=byReleaseTime&genres=${genres}'>按更新</a> 
 </div>
	      ...
	      if(moviesList!=null){
	       for(int i=1;i<=3&&((i-1)*4<moviesList.size());i++){
	          ...
	          for(int j=0;j<4&&((i-1)*4+j<moviesList.size());j++){
			    ...
			    out.println("<li ><a href='http://121.42.174.147:8080/Movie/getMovieDetail.action?movie_id="+moviesList.get((i-1)*4+j).getMovie_id()+
