		      ...
		      if(moviesList!=null&&moviesList.size()>0){
		       ...
		       for(int i=1;i<=3&&((i-1)*4<moviesList.size());i++){
		          ...
		          for(int j=0;j<4&&((i-1)*4+j<moviesList.size());j++){
				    ...
				    out.println("<li><a href='http://121.42.174.147:8080/Movie/getMovieDetailAndCollectFeedback.action?movie_id="+moviesList.get((i-1)*4+j).getMovie_id()+
				    "'><img src='"+picurl+"'/><br/>"+movie_name+"</a></li>");
			      }
			     out.println("</ul>");
		         out.println("</div>");
		       }
		       out.println("<font color='red' size=3>请点击推荐给您的电影进行评价，您的真实评价用来评估推荐系统的精度，这对于我们的研究和学习极其重要！</br>谢谢亲!</br>");
		       out.println("<font color='green' size=3>If you find any problems, or interested in the recommendation system, please contact me via email, cell phone or WeChat!</font></br>");
                       out.println("<font color='green' size=3>Email : 2361660127@qq.com</font></br>");
                       out.println("<font color='green' size=3>Phone number : 15951965799</font></br>");
                       out.println("<font color='green' size=3>Wechat number : batsqd</font></br>");                      
                       out.println("<font color='green' size=3>Thank You!</font></br></br>"); 
                       out.println("<font color='green' size=3>Zhiyuan Yuan!</font>"); 
