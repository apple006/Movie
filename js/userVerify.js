$(document).ready(function(){
	...
	$("#login-button").click(function(){
			...
			if(userName==""|password==""){
				...
				$.ajax({
				    type:'POST',
					url:'http://121.42.174.147:8080/Movie/validation.action',
					...
					success:function(data){
						...
						return false; 
							...
							//进入主页面
						    window.location.href = "http://121.42.174.147:8080/Movie/showHome.action";//跳转到主页 
						}
					}
				}); 
			}
		  ...
		  if(username_register==""|| password_register==""|| password_register_again==""){
			  ...
			  $("#registerMessageBox").html("请填入完整注册信息！");
			    ...
			    //alert("enter。。。");
				  $.ajax({
					    type:'POST',
						url:'http://121.42.174.147:8080/Movie/register.action',
